...
interface PinubiLogoProps {
  size?: number;
  color?: string;
}

const PinubiLogo: React.FC<PinubiLogoProps> = ({ 
  size = 32, 
  color = '#b13bff' // primary-500 color
}) => {
  return (
    <Svg
      width={size}
      height={size * (512 / 288)} // Maintain aspect ratio
      viewBox="0 0 288 512"
      fill={color}
    >
      <Path
